  ...
  return (
    ...
    <div className="flex flex-col min-h-screen overflow-x-hidden ">
      <main className="flex-1">
       ...
       {/* Page-1 Products */}
<section className="bg-[#FEFBEA] py-12 px-6 md:px-12">
...
<section className="py-16 px-2 sm:px-8 lg:px-16 bg-white">
  <div className="max-w-[1600px] mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
      {/* CARD 1 */}
      <div className="relative rounded-l overflow-hidden group shadow-lg bg-gray-100 min-h-[420px] flex items-end">
        <img 
          src="/banners/landscape-07.png" // use your actual image path
          alt="Blouse Beaut"
          className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
        />
        <div className="absolute inset-0 bg-gradient-to-bl from-black/60 to-transparent" />
        <div className="relative z-10 p-8">
          <h3 className="text-3xl font-bold text-white mb-4 drop-shadow-lg">Blouse Beaut</h3>
          <p className="text-white text-lg mb-6 opacity-90">Ultra Glam Fits for Iconic Hits</p>
          <Link
            href="#"
            className="inline-block bg-white text-gray-900 font-semibold px-6 py-3 rounded-full shadow hover:bg-gray-200 transition"
            prefetch={false}
          >
            Shop Now
          </Link>
      ...
      <div className="relative rounded-l overflow-hidden group shadow-lg bg-gray-100 min-h-[420px] flex items-end">
        <img 
          src="/banners/landscape-06.png" // use your actual image path
          alt="Indowestern Edit"
          className="absolute inset-0 w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
        />
        <div className="absolute inset-0 bg-gradient-to-tr from-black/50 to-transparent" />
        <div className="relative z-10 p-8">
          <h3 className="text-3xl font-bold text-white mb-4 drop-shadow-lg">Indowestern Edit</h3>
          <p className="text-white text-lg mb-6 opacity-90">Serving Looks For Every Vibe</p>
          <Link
            href="#"
            className="inline-block bg-white text-gray-900 font-semibold px-6 py-3 rounded-full shadow hover:bg-gray-200 transition"
            prefetch={false}
...
<section className="py-16 px-4 sm:px-8 lg:px-12 bg-white">
  <div className="max-w-6xl mx-auto">
    {/* Heading */}
    <h2 className="text-center text-red-600 font-bold text-3xl md:text-4xl mb-10 tracking-wide">
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
      {/* Post 1 */}
      <a
        href="https://instagram.com/yourprofile" // Replace with actual post URL
        target="_blank"
        rel="noopener noreferrer"
        className="group relative block overflow-hidden rounded-lg shadow hover:shadow-xl transition"
      >
        <img
          src="/instagram/1.jpg" // Replace with your post image
          alt="Instagram post"
          className="w-full h-80 object-cover transition-transform duration-300 group-hover:scale-105"
        />
        {/* Optional overlay badge */}
        <span className="absolute top-2 right-2 bg-white bg-opacity-90 text-pink-700 rounded-full px-3 py-1 font-bold text-xs shadow">
          #Rakhi
        </span>
        {/* Overlay text for post */}
        <span className="absolute bottom-2 left-3 text-white text-lg font-semibold shadow-lg drop-shadow">
          Something New, No?
        </span>
      </a>
      ...
      >
        ...
        <span className="absolute left-5 bottom-8 text-white font-bold text-xl shadow drop-shadow-lg">
          If you miss my hints this year,<br />I'm sending a PPT next time.
        </span>
        <span className="absolute top-2 right-2 bg-white bg-opacity-90 text-pink-700 rounded-full px-3 py-1 font-bold text-xs shadow">
          #Rakhi
        </span>
    ...
    {/* CTA (optional, to drive followers) */}
    <div className="text-center mt-8">
      <a
        href="https://instagram.com/yourprofile"
        target="_blank"
        rel="noopener noreferrer"
        className="inline-block mt-2 px-8 py-3 rounded-full bg-gradient-to-r from-red-600 to-yellow-400 text-white font-bold text-lg shadow hover:scale-105 hover:shadow-xl transition"
      >
...
<section className="w-full bg-gradient-to-br from-pink-200 via-white to-orange-100 py-16 flex flex-col items-center justify-center px-4 sm:px-8 lg:px-0">
  <div className="max-w-3xl w-full mx-auto text-center">
    ...
    >
      ...
      <footer className="bg-white-100 text-black py-10 px-6 mt-10 border-t border-gray-800">
        <div className="max-w-[1500px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          {/* Customer Service */}
          <div>
            <h3 className="font-semibold text-lg mb-3 text-black">Customer Service</h3>
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-grey">Help Center</a></li>
              <li><a href="#" className="hover:text-grey">Returns</a></li>
              <li><a href="#" className="hover:text-grey">Shipping Info</a></li>
              <li><a href="#" className="hover:text-grey">Track Order</a></li>
            </ul>
          </div>
          {/* Newsletter */}
          <div>
            <h3 className="font-semibold text-lg mb-3 text-black">Newsletter</h3>
          ...
          {/* Payments */}
          <div>
            <h3 className="font-semibold text-lg mb-3 text-black">We Accept</h3>
        ...
        <div className="text-center text-xs text-vback-500 mt-8">&copy; 2024 RoyalStore. All rights reserved.</div>
      </footer>
    </div>
  );
}
